...
import { User, WrongQuestion, UserRole, AssessmentQuestion, KnowledgeMastery } from '@/lib/supabase'
...
interface AppState {
  ...
  assessmentRecords: { question_id: string; user_answer: string; is_correct: boolean; answered_at: string }[]
